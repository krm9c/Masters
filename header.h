...
#define ForwardDirection    0x1000

#define VelocityMode        0x0800

#define PositionMode        0x0000

#define StopSmoothlyCmd     0x0400

#define StopAbruptlyCmd     0x0200

#define TurnOffMotorCmd     0x0100

#define TurnOnMotorCmd      0x0000

#define LoadAccBit          0x0020

#define AccRelBit           0x0010

#define LoadVelBit          0x0008

#define VelRelBit           0x0004

#define LoadPosBit          0x0002

#define PosRelBit           0x0001

#define LoadAllTraj         (LoadAccBit | LoadVelBit | LoadPosBit)



/* load filter command (LFIL) control bits*/

#define LoadKPBit           0x08

#define LoadKIBit           0x04

#define LoadKDBit           0x02

#define LoadILBit           0x01

#define LoadAllFil          (LoadKPBit | LoadKIBit | LoadKDBit | LoadILBit)

//motor control functions,structures and variable declarations
